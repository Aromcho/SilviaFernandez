...
const TemporalItemList = () => {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(`/api/property/properties?limit=${limit}&offset=${offset}&operation_type=Alquiler temporario`)
...
export default TemporalItemList;
