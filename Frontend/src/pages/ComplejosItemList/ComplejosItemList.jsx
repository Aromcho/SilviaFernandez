    ...
    <>
      <header className="hero-section mt-5 pt-5">
        <Container className="text-center text-white mt-5 pt-5">
          <Typography variant="h3" className="hero-title">Complejos en Mar Azul, Mar de las Pampas y Las Gaviotas</Typography>
          <p className="hero-subtitle">Encuentra el Complejo ideal para vacacionar en familia.</p>
        </Container>
      </header>
      
      <Container className='px-0 mt-5'>
        <div className="item-list-terrenos">
          {loading ? (
            [...Array(4)].map((_, index) => (
...
export default ComplejosItemList;
